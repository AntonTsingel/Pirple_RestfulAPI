...
cli.responders.help = function(){
 var commands = {
    ...
    'stats': 'Get statictics on the underlying operating system and resource utilization',
    'list users': 'Show a list of all the registered (undeleted) users in the system',
    'more user info --{userId}': 'Show details of a specific user',
    'list checks --up --down': 'Show the list of all the active checks in the system, including their state The "--up" and the "--down" flags are both optional' ,
    'more check info --{checkId}': 'Show details of the specified checks',
    ...
    if(logFileName){
        ...
        _logs.decompress(logFileName,function(err,strData){
            if(!err && strData){
                ...
                arr.forEaach(function(jsonString){
