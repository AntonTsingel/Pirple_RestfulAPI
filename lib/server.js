   ...
   req.on('end',function(){
    ...
    try{
       chosenHandler(data, function(statusCode, payload,contentType){
        server.processHandlerResponse(res,method,trimmedPath,payload,statusCode,contentType)
...
server.processHandlerResponse = function(res,method,trimmedPath,payload,statusCode,contentType){
